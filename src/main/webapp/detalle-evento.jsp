        ...
        <c:choose>
            <c:when test="${not empty evento}">
                <div class="card p-4 shadow-sm border-0 rounded-4 bg-white mb-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <img src="${not empty evento.foto ? evento.foto : 'img/personas.jpg'}" alt="Evento" class="img-fluid rounded-4" style="width:100%; height:320px; object-fit:cover;">
                        </div>
                        <div class="col-md-6 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <p class="text-secondary mb-2">${evento.descripcion}</p>
