        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2 mt-lg-0 ms-4">
                ...
                <c:if test="${sessionScope.usuario != null && (sessionScope.usuario.idRol == 1 || sessionScope.usuario.idRol == 2)}">
                    <li class="nav-item">
                        <a class="nav-link ${paginaActiva == 'eventos' ? 'active' : ''}" href="${pageContext.request.contextPath}/evento?action=gestion">Eventos</a>
                    </li>
                </c:if>
            ...
            <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                ...
                <a href="${pageContext.request.contextPath}/logout" class="nav-icon-logout shadow-sm d-flex align-items-center justify-content-center text-decoration-none" title="Cerrar sesión">
