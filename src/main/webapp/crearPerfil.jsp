    ...
    <div class="row">
        ...
        <div class="col-md-3 pe-4">
            <div class="d-flex flex-column">
                ...
                <a href="reservar.jsp" class="btn sidebar-btn py-3 px-4 fw-bold"><i class="bi bi-calendar-check me-3"></i> Reservas</a>
                <a href="#" class="btn sidebar-btn py-3 px-4 fw-bold"><i class="bi bi-people me-3"></i> Usuarios</a>
                <a href="#" class="btn sidebar-btn py-3 px-4 fw-bold"><i class="bi bi-file-earmark-text me-3"></i> Auditoría</a>
